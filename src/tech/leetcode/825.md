...
tags: Medium Array TwoPointers BinarySearch Sorting
---

[View on LeetCode](https://leetcode.com/problems/friends-of-appropriate-ages/)

**Approach:** Age histogram and prefix sums; for each age ≥15, count valid requesters minus self.

**Complexity:** O(1) time (ages ≤120), O(1) space
