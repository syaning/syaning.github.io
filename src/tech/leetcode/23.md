...
tags: Hard LinkedList DivideAndConquer HeapPriorityQueue MergeSort TournamentSort
---

[View on LeetCode](https://leetcode.com/problems/merge-k-sorted-lists/)

**Approach:** Divide-and-conquer: recursively split the k lists in half, then merge the two halves with the standard two-list merge.

**Complexity:** O(N log k) time, O(log k) space
