...
tags: Medium Array String Backtracking DepthFirstSearch Matrix
---

[View on LeetCode](https://leetcode.com/problems/word-search/)

**Approach:** DFS from every cell: match the next letter, mark visited by clearing the cell, recurse four ways, then restore.
