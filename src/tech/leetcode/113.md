...
tags: Medium Backtracking Tree DepthFirstSearch BinaryTree
---

[View on LeetCode](https://leetcode.com/problems/path-sum-ii/)

**Approach:** DFS with path accumulation; at a leaf whose remaining sum matches, record a copy of the path.

**Complexity:** O(n·h) time, O(h) space besides output
