...
tags: Medium Array Backtracking
---

[View on LeetCode](https://leetcode.com/problems/combination-sum/)

**Approach:** Sort candidates and backtrack with reuse at the same index; skip duplicates at one depth; stop when remaining target is 0.

**Complexity:** O(n^{T/min}) time, O(T/min) space
