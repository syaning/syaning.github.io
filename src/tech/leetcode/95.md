...
tags: Medium DynamicProgramming Backtracking Tree BinarySearchTree BinaryTree
---

[View on LeetCode](https://leetcode.com/problems/unique-binary-search-trees-ii/)

**Approach:** For each root in [min,max], recursively generate all left and right BST shapes and combine them.

**Complexity:** O(Cₙ·n) time, O(Cₙ·n) space
