...
tags: Medium LinkedList Tree DepthFirstSearch BreadthFirstSearch BinaryTree
---

[View on LeetCode](https://leetcode.com/problems/populating-next-right-pointers-in-each-node-ii/)

**Approach:** Level by level via existing next links: scan parents, stitch children into the next level.
