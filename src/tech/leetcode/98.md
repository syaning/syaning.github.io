...
tags: Medium Tree DepthFirstSearch BinarySearchTree BinaryTree
---

[View on LeetCode](https://leetcode.com/problems/validate-binary-search-tree/)

**Approach:** DFS with (min,max) bounds: each node must lie strictly inside, then tighten bounds for children.
