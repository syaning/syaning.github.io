...
tags: Medium LinkedList DivideAndConquer Tree BinarySearchTree BinaryTree
---

[View on LeetCode](https://leetcode.com/problems/convert-sorted-list-to-binary-search-tree/)

**Approach:** Copy the sorted list into an array, then build a balanced BST by recursively taking the mid as root.
