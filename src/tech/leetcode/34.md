...
**Approach:** Recursive binary search; on a hit, recurse both sides and merge the outermost indices of the target range.

**Complexity:** O(log n) average / O(n) worst time, O(log n) space
