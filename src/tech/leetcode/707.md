...
tags: Medium LinkedList Design
---

[View on LeetCode](https://leetcode.com/problems/design-linked-list/)

**Approach:** Singly linked list with head, tail, and size; get/add/delete by scanning to the index.

**Complexity:** O(n) per op, O(n) space
