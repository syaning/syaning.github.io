...
[View on LeetCode](https://leetcode.com/problems/queens-that-can-attack-the-king/)

**Approach:** For each of 8 rays from the king, keep the closest queen; return those.

**Complexity:** O(q) time, O(1) space
