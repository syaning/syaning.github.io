...
![]({{site.baseurl}}/images/2018/04/10/13-1.png)
...
![]({{site.baseurl}}/images/2018/04/10/13-2.png)

在每个RNN单元内，计算如下：

![]({{site.baseurl}}/images/2018/04/10/13-3.png)
...
![]({{site.baseurl}}/images/2018/04/10/13-4.png)

## 4. 不同类型的RNN

RNN根据实际场景，有着不同的结构。如下图所示：

![]({{site.baseurl}}/images/2018/04/10/13-5.png)
...
3. 构建RNN网络来进行训练
    ...
    ![]({{site.baseurl}}/images/2018/04/10/13-6.png)
...
![]({{site.baseurl}}/images/2018/04/10/13-7.png)

在训练好了一个序列模型后，要想知道这个模型学到了什么，可以进行一次新序列采样，从而生成一段随机的序列。在对新序列采样过程中，网络结构有一些不同，如下所示：

![]({{site.baseurl}}/images/2018/04/10/13-8.png)
...
![]({{site.baseurl}}/images/2018/04/10/13-9.png)
...
![]({{site.baseurl}}/images/2018/04/10/13-10.png)
...
![]({{site.baseurl}}/images/2018/04/10/13-11.png)

## 10. 深层RNN

通过增加隐藏层来构建更深的RNN网络。如图所示：

![]({{site.baseurl}}/images/2018/04/10/13-12.png)
