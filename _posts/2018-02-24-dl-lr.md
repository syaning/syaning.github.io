...
![]({{site.baseurl}}/images/deeplearning/1.png)

在训练的时候，将图片进行铺平展开，如下图所示：

<img src="{{site.baseurl}}/images/deeplearning/2.png" style="width:150px">
...
![]({{site.baseurl}}/images/deeplearning/3.png)
