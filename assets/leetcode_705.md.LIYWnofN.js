import{_ as i,c as a,a3 as n,o as l}from"./chunks/framework.DIwpdX6V.js";const E=JSON.parse('{"title":"705. Design HashSet","description":"","frontmatter":{},"headers":[],"relativePath":"leetcode/705.md","filePath":"leetcode/705.md"}'),p={name:"leetcode/705.md"};function h(t,s,k,e,r,d){return l(),a("div",null,s[0]||(s[0]=[n(`<h1 id="_705-design-hashset" tabindex="-1">705. Design HashSet <a class="header-anchor" href="#_705-design-hashset" aria-label="Permalink to &quot;705. Design HashSet&quot;">​</a></h1><p><a href="https://leetcode.com/problems/design-hashset/" target="_blank" rel="noreferrer">https://leetcode.com/problems/design-hashset/</a></p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-Teffb" id="tab-9EAGTF2" checked><label data-title="JavaScript" for="tab-9EAGTF2">JavaScript</label><input type="radio" name="group-Teffb" id="tab-u0-e98A"><label data-title="Python" for="tab-u0-e98A">Python</label></div><div class="blocks"><div class="language-js vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">/**</span></span>
