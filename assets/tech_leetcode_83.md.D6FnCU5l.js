import{_ as i,c as a,af as n,o as l}from"./chunks/framework.8uRxeVQf.js";const c=JSON.parse('{"title":"83. Remove Duplicates from Sorted List","description":"","frontmatter":{"title":"83. Remove Duplicates from Sorted List","tags":"Easy LinkedList","postMeta":true},"headers":[],"relativePath":"tech/leetcode/83.md","filePath":"tech/leetcode/83.md"}'),p={name:"tech/leetcode/83.md"};function t(e,s,h,k,r,d){return l(),a("div",null,s[0]||(s[0]=[n(`<p><a href="https://leetcode.com/problems/remove-duplicates-from-sorted-list/" target="_blank" rel="noreferrer">View on LeetCode</a></p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-GjVi9" id="tab-SRkc9yR" checked><label data-title="js" for="tab-SRkc9yR">js</label><input type="radio" name="group-GjVi9" id="tab-NQs4j22"><label data-title="py" for="tab-NQs4j22">py</label></div><div class="blocks"><div class="language-js vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">/**</span></span>
