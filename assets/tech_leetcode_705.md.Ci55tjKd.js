import{_ as i,c as a,af as n,o as l}from"./chunks/framework.8uRxeVQf.js";const E=JSON.parse('{"title":"705. Design HashSet","description":"","frontmatter":{"title":"705. Design HashSet","tags":"Easy Array HashTable LinkedList Design HashFunction","postMeta":true},"headers":[],"relativePath":"tech/leetcode/705.md","filePath":"tech/leetcode/705.md"}'),p={name:"tech/leetcode/705.md"};function t(h,s,k,e,r,d){return l(),a("div",null,s[0]||(s[0]=[n(`<p><a href="https://leetcode.com/problems/design-hashset/" target="_blank" rel="noreferrer">View on LeetCode</a></p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-4PxPM" id="tab-aF-1t7V" checked><label data-title="js" for="tab-aF-1t7V">js</label><input type="radio" name="group-4PxPM" id="tab-K2Z-4Ae"><label data-title="py" for="tab-K2Z-4Ae">py</label></div><div class="blocks"><div class="language-js vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">/**</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># obj.add(key)</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># obj.remove(key)</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># param_3 = obj.contains(key)</span></span></code></pre></div></div></div>`,2)]))}const g=i(p,[["render",t]]);export{E as __pageData,g as default};
