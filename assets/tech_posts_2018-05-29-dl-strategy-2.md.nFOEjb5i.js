...
<span class="line"><span>                   ↓</span></span>
<span class="line"><span>       Test Error ---</span></span></code></pre></div><h2 id="_4-迁移学习" tabindex="-1">4. 迁移学习 <a class="header-anchor" href="#_4-迁移学习" aria-label="Permalink to &quot;4. 迁移学习&quot;">​</a></h2><p>即将已经训练好的模型的参数应用到新模型的训练上。因为很多低层次的特征是相对通用的，例如边缘检测等。通常的做法是将训练好的模型的输出层去掉，然后后面加上一层或多层网络结构接着训练。如图所示：</p><p><img src="`+t+'" alt=""></p><h2 id="_5-多任务学习" tabindex="-1">5. 多任务学习 <a class="header-anchor" href="#_5-多任务学习" aria-label="Permalink to &quot;5. 多任务学习&quot;">​</a></h2><p>例如要训练一个自动驾驶系统，需要识别车辆、行人、信号灯、路标等各种标识。可以对每一种需要识别的物体都分别训练一个模型来进行识别。但更好的做法是通过一个模型来识别这多种物体。多任务学习常用语计算机视觉领域。</p><h2 id="_6-端到端的深度学习" tabindex="-1">6. 端到端的深度学习 <a class="header-anchor" href="#_6-端到端的深度学习" aria-label="Permalink to &quot;6. 端到端的深度学习&quot;">​</a></h2><p><img src="'+l+'" alt=""></p>',17)]))}const m=s(i,[["render",r]]);export{g as __pageData,m as default};
