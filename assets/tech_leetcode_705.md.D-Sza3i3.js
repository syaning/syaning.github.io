import{_ as i,c as a,a1 as n,o as l}from"./chunks/framework.Czrn5xjl.js";const E=JSON.parse('{"title":"705. Design HashSet","description":"","frontmatter":{"title":"705. Design HashSet","tags":"Easy Array HashTable LinkedList Design HashFunction","postMeta":true},"headers":[],"relativePath":"tech/leetcode/705.md","filePath":"tech/leetcode/705.md"}'),p={name:"tech/leetcode/705.md"};function t(h,s,k,e,r,d){return l(),a("div",null,s[0]||(s[0]=[n(`<p><a href="https://leetcode.com/problems/design-hashset/" target="_blank" rel="noreferrer">View on LeetCode</a></p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-niFEu" id="tab-veFYUoj" checked><label data-title="js" for="tab-veFYUoj">js</label><input type="radio" name="group-niFEu" id="tab-AtxcVO8"><label data-title="py" for="tab-AtxcVO8">py</label></div><div class="blocks"><div class="language-js vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">/**</span></span>
