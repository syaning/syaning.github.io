import{_ as i,c as a,ae as n,o as t}from"./chunks/framework.DM8_VfBh.js";const E=JSON.parse('{"title":"226. Invert Binary Tree","description":"","frontmatter":{"title":"226. Invert Binary Tree","tags":"Easy Tree DepthFirstSearch BreadthFirstSearch BinaryTree","postMeta":true},"headers":[],"relativePath":"tech/leetcode/226.md","filePath":"tech/leetcode/226.md"}'),l={name:"tech/leetcode/226.md"};function e(p,s,h,k,r,d){return t(),a("div",null,s[0]||(s[0]=[n(`<p><a href="https://leetcode.com/problems/invert-binary-tree/" target="_blank" rel="noreferrer">View on LeetCode</a></p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-iB1qo" id="tab-uU2Xh9B" checked><label data-title="JavaScript" for="tab-uU2Xh9B">JavaScript</label><input type="radio" name="group-iB1qo" id="tab-A3DxEKK"><label data-title="Python" for="tab-A3DxEKK">Python</label><input type="radio" name="group-iB1qo" id="tab-A-iOkFf"><label data-title="Go" for="tab-A-iOkFf">Go</label></div><div class="blocks"><div class="language-js vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">/**</span></span>
...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">    invertTree</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(root.Right)</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">    return</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> root</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div></div></div>`,2)]))}const g=i(l,[["render",e]]);export{E as __pageData,g as default};
