import{_ as s,o as n,c as a,V as l}from"./chunks/framework.16eef3c0.js";const C=JSON.parse('{"title":"将静态资源打包进go binary","description":"","frontmatter":{"layout":"post","title":"将静态资源打包进go binary","date":"2022-11-19 11:00:00 +0800"},"headers":[],"relativePath":"posts/2022-11-19-go-embed.md"}'),p={name:"posts/2022-11-19-go-embed.md"},o=l(`<p>在使用 Go 进行开发的时候，经常会遇到一些需要以来静态资源的情况，例如：</p><ul><li>配置文件</li><li>管理后台的静态资源（各种 HTML、CSS、JS、图片等）</li></ul><p>在这种情况下，如果最终的发布包是一个二进制文件和一堆所依赖的静态资源，使用起来就会非常不方便，例如：</p><ul><li>由于资源路径等问题导致的资源无法解析</li><li>误删资源文件导致程序崩溃</li></ul><p>在这种情况下，我们可以通过 <code>embed</code> 包将静态资源打包进二进制文件中，这样最终只需要发布一个二进制文件即可。</p><p>通过引入 <code>embed</code> 包以及 <code>//go: embed</code> 指令就可以将静态资源打包进发布包，支持将文件打包为如下三种格式：</p><ul><li><code>string</code></li><li><code>[]byte</code></li><li><code>embed.FS</code></li></ul><p>例如：</p><div class="language-go"><button title="Copy Code" class="copy"></button><span class="lang">go</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#89DDFF;">package</span><span style="color:#A6ACCD;"> </span><span style="color:#FFCB6B;">main</span></span>
