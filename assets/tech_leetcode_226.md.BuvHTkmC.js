import{_ as i,c as a,ae as n,o as t}from"./chunks/framework.DM8_VfBh.js";const g=JSON.parse('{"title":"226. Invert Binary Tree","description":"","frontmatter":{"title":"226. Invert Binary Tree","tags":"Easy Tree DepthFirstSearch BreadthFirstSearch BinaryTree","postMeta":true},"headers":[],"relativePath":"tech/leetcode/226.md","filePath":"tech/leetcode/226.md"}'),l={name:"tech/leetcode/226.md"};function e(p,s,h,k,r,d){return t(),a("div",null,s[0]||(s[0]=[n(`<p><a href="https://leetcode.com/problems/invert-binary-tree/" target="_blank" rel="noreferrer">View on LeetCode</a></p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-iTf4r" id="tab-XPdj0-L" checked><label data-title="js" for="tab-XPdj0-L">js</label><input type="radio" name="group-iTf4r" id="tab-tR36_j7"><label data-title="py" for="tab-tR36_j7">py</label><input type="radio" name="group-iTf4r" id="tab-jK5ZRZZ"><label data-title="go" for="tab-jK5ZRZZ">go</label></div><div class="blocks"><div class="language-js vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">/**</span></span>
