import{_ as i,c as a,a4 as n,o as t}from"./chunks/framework.zvAqeJ2b.js";const g=JSON.parse('{"title":"114. Flatten Binary Tree to Linked List","description":"","frontmatter":{},"headers":[],"relativePath":"leetcode/114.md","filePath":"leetcode/114.md"}'),l={name:"leetcode/114.md"};function p(h,s,e,k,r,E){return t(),a("div",null,s[0]||(s[0]=[n(`<h1 id="_114-flatten-binary-tree-to-linked-list" tabindex="-1">114. Flatten Binary Tree to Linked List <a class="header-anchor" href="#_114-flatten-binary-tree-to-linked-list" aria-label="Permalink to &quot;114. Flatten Binary Tree to Linked List&quot;">​</a></h1><p><a href="https://leetcode.com/problems/flatten-binary-tree-to-linked-list/" target="_blank" rel="noreferrer">https://leetcode.com/problems/flatten-binary-tree-to-linked-list/</a></p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-4q_j_" id="tab-Ci7_0Gh" checked><label data-title="JavaScript" for="tab-Ci7_0Gh">JavaScript</label><input type="radio" name="group-4q_j_" id="tab-1RcwycT"><label data-title="Python" for="tab-1RcwycT">Python</label><input type="radio" name="group-4q_j_" id="tab-agpupCu"><label data-title="Go" for="tab-agpupCu">Go</label></div><div class="blocks"><div class="language-js vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">/**</span></span>
