import{_ as i,c as a,a1 as n,o as l}from"./chunks/framework.Czrn5xjl.js";const c=JSON.parse('{"title":"83. Remove Duplicates from Sorted List","description":"","frontmatter":{"title":"83. Remove Duplicates from Sorted List","tags":"Easy LinkedList","postMeta":true},"headers":[],"relativePath":"tech/leetcode/83.md","filePath":"tech/leetcode/83.md"}'),p={name:"tech/leetcode/83.md"};function t(e,s,h,k,r,d){return l(),a("div",null,s[0]||(s[0]=[n(`<p><a href="https://leetcode.com/problems/remove-duplicates-from-sorted-list/" target="_blank" rel="noreferrer">View on LeetCode</a></p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-Es5bX" id="tab-SMBTu04" checked><label data-title="js" for="tab-SMBTu04">js</label><input type="radio" name="group-Es5bX" id="tab-csDGIE9"><label data-title="py" for="tab-csDGIE9">py</label></div><div class="blocks"><div class="language-js vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">/**</span></span>
