import{_ as i,c as a,ae as n,o as t}from"./chunks/framework.DM8_VfBh.js";const g=JSON.parse('{"title":"114. Flatten Binary Tree to Linked List","description":"","frontmatter":{"title":"114. Flatten Binary Tree to Linked List","tags":"Medium LinkedList Stack Tree DepthFirstSearch BinaryTree","postMeta":true},"headers":[],"relativePath":"tech/leetcode/114.md","filePath":"tech/leetcode/114.md"}'),l={name:"tech/leetcode/114.md"};function p(h,s,e,k,r,E){return t(),a("div",null,s[0]||(s[0]=[n(`<p><a href="https://leetcode.com/problems/flatten-binary-tree-to-linked-list/" target="_blank" rel="noreferrer">View on LeetCode</a></p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-uc6ey" id="tab-HCECow2" checked><label data-title="JavaScript" for="tab-HCECow2">JavaScript</label><input type="radio" name="group-uc6ey" id="tab-puc8005"><label data-title="Python" for="tab-puc8005">Python</label><input type="radio" name="group-uc6ey" id="tab-I4kDoDv"><label data-title="Go" for="tab-I4kDoDv">Go</label></div><div class="blocks"><div class="language-js vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">/**</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">	}</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div></div></div>`,2)]))}const o=i(l,[["render",p]]);export{g as __pageData,o as default};
