import{_ as i,c as a,ae as n,o as l}from"./chunks/framework.DM8_VfBh.js";const g=JSON.parse('{"title":"83. Remove Duplicates from Sorted List","description":"","frontmatter":{"title":"83. Remove Duplicates from Sorted List","tags":"Easy LinkedList","postMeta":true},"headers":[],"relativePath":"tech/leetcode/83.md","filePath":"tech/leetcode/83.md"}'),p={name:"tech/leetcode/83.md"};function t(e,s,h,k,r,d){return l(),a("div",null,s[0]||(s[0]=[n(`<p><a href="https://leetcode.com/problems/remove-duplicates-from-sorted-list/" target="_blank" rel="noreferrer">View on LeetCode</a></p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-FwPgg" id="tab-JdT1zIi" checked><label data-title="js" for="tab-JdT1zIi">js</label><input type="radio" name="group-FwPgg" id="tab-8XCoVZo"><label data-title="py" for="tab-8XCoVZo">py</label></div><div class="blocks"><div class="language-js vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">/**</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">        return</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> head</span></span></code></pre></div></div></div>`,2)]))}const c=i(p,[["render",t]]);export{g as __pageData,c as default};
