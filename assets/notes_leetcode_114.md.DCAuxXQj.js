import{_ as s,c as i,o as a,a4 as n}from"./chunks/framework.C7_4Vmd4.js";const y=JSON.parse('{"title":"114. Flatten Binary Tree to Linked List","description":"","frontmatter":{},"headers":[],"relativePath":"notes/leetcode/114.md","filePath":"notes/leetcode/114.md"}'),t={name:"notes/leetcode/114.md"},l=n(`<h1 id="_114-flatten-binary-tree-to-linked-list" tabindex="-1">114. Flatten Binary Tree to Linked List <a class="header-anchor" href="#_114-flatten-binary-tree-to-linked-list" aria-label="Permalink to &quot;114. Flatten Binary Tree to Linked List&quot;">​</a></h1><p><a href="https://leetcode.com/problems/flatten-binary-tree-to-linked-list/" target="_blank" rel="noreferrer">https://leetcode.com/problems/flatten-binary-tree-to-linked-list/</a></p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-qDgtO" id="tab-dpWE2Pr" checked><label for="tab-dpWE2Pr">JavaScript</label><input type="radio" name="group-qDgtO" id="tab-klI7Ubc"><label for="tab-klI7Ubc">Python</label><input type="radio" name="group-qDgtO" id="tab-O6OVUHD"><label for="tab-O6OVUHD">Go</label></div><div class="blocks"><div class="language-js vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">/**</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">	}</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div></div></div>`,3),p=[l];function h(e,k,r,E,d,g){return a(),i("div",null,p)}const c=s(t,[["render",h]]);export{y as __pageData,c as default};
