import{_ as s,c as i,o as a,a5 as n}from"./chunks/framework.DdR-ZOnh.js";const y=JSON.parse('{"title":"114. Flatten Binary Tree to Linked List","description":"","frontmatter":{},"headers":[],"relativePath":"notes/leetcode/114.md","filePath":"notes/leetcode/114.md","lastUpdated":1685724191000}'),t={name:"notes/leetcode/114.md"},l=n(`<h1 id="_114-flatten-binary-tree-to-linked-list" tabindex="-1">114. Flatten Binary Tree to Linked List <a class="header-anchor" href="#_114-flatten-binary-tree-to-linked-list" aria-label="Permalink to &quot;114. Flatten Binary Tree to Linked List&quot;">​</a></h1><p><a href="https://leetcode.com/problems/flatten-binary-tree-to-linked-list/" target="_blank" rel="noreferrer">https://leetcode.com/problems/flatten-binary-tree-to-linked-list/</a></p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-Ph7G6" id="tab-bQFb01v" checked><label data-title="JavaScript" for="tab-bQFb01v">JavaScript</label><input type="radio" name="group-Ph7G6" id="tab-uBUZWtj"><label data-title="Python" for="tab-uBUZWtj">Python</label><input type="radio" name="group-Ph7G6" id="tab-WkEGbiH"><label data-title="Go" for="tab-WkEGbiH">Go</label></div><div class="blocks"><div class="language-js vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">/**</span></span>
