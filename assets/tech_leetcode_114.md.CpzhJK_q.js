import{_ as i,c as a,ah as n,o as t}from"./chunks/framework.B3LYeojb.js";const g=JSON.parse('{"title":"114. Flatten Binary Tree to Linked List","description":"","frontmatter":{},"headers":[],"relativePath":"tech/leetcode/114.md","filePath":"tech/leetcode/114.md"}'),l={name:"tech/leetcode/114.md"};function p(h,s,e,k,r,E){return t(),a("div",null,s[0]||(s[0]=[n(`<h1 id="_114-flatten-binary-tree-to-linked-list" tabindex="-1">114. Flatten Binary Tree to Linked List <a class="header-anchor" href="#_114-flatten-binary-tree-to-linked-list" aria-label="Permalink to &quot;114. Flatten Binary Tree to Linked List&quot;">​</a></h1><p><a href="https://leetcode.com/problems/flatten-binary-tree-to-linked-list/" target="_blank" rel="noreferrer">https://leetcode.com/problems/flatten-binary-tree-to-linked-list/</a></p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-dl07o" id="tab-8OVaDMG" checked><label data-title="JavaScript" for="tab-8OVaDMG">JavaScript</label><input type="radio" name="group-dl07o" id="tab-e1PvOob"><label data-title="Python" for="tab-e1PvOob">Python</label><input type="radio" name="group-dl07o" id="tab-4TjBpnq"><label data-title="Go" for="tab-4TjBpnq">Go</label></div><div class="blocks"><div class="language-js vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">/**</span></span>
