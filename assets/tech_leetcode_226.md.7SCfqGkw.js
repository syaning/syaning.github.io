import{_ as i,c as a,af as n,o as t}from"./chunks/framework.8uRxeVQf.js";const g=JSON.parse('{"title":"226. Invert Binary Tree","description":"","frontmatter":{"title":"226. Invert Binary Tree","tags":"Easy Tree DepthFirstSearch BreadthFirstSearch BinaryTree","postMeta":true},"headers":[],"relativePath":"tech/leetcode/226.md","filePath":"tech/leetcode/226.md"}'),l={name:"tech/leetcode/226.md"};function e(p,s,h,k,r,d){return t(),a("div",null,s[0]||(s[0]=[n(`<p><a href="https://leetcode.com/problems/invert-binary-tree/" target="_blank" rel="noreferrer">View on LeetCode</a></p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-1ONj2" id="tab-koq0q74" checked><label data-title="js" for="tab-koq0q74">js</label><input type="radio" name="group-1ONj2" id="tab-bv4ZXGF"><label data-title="py" for="tab-bv4ZXGF">py</label><input type="radio" name="group-1ONj2" id="tab-B-DUH49"><label data-title="go" for="tab-B-DUH49">go</label></div><div class="blocks"><div class="language-js vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">/**</span></span>
...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">    invertTree</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(root.Right)</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">    return</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> root</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div></div></div>`,2)]))}const E=i(l,[["render",e]]);export{g as __pageData,E as default};
