import{_ as i,c as a,af as n,o as t}from"./chunks/framework.8uRxeVQf.js";const g=JSON.parse('{"title":"114. Flatten Binary Tree to Linked List","description":"","frontmatter":{"title":"114. Flatten Binary Tree to Linked List","tags":"Medium LinkedList Stack Tree DepthFirstSearch BinaryTree","postMeta":true},"headers":[],"relativePath":"tech/leetcode/114.md","filePath":"tech/leetcode/114.md"}'),l={name:"tech/leetcode/114.md"};function p(h,s,e,k,r,E){return t(),a("div",null,s[0]||(s[0]=[n(`<p><a href="https://leetcode.com/problems/flatten-binary-tree-to-linked-list/" target="_blank" rel="noreferrer">View on LeetCode</a></p><p><strong>Approach:</strong> Post-order flatten both sides; splice the left chain onto the right, hanging the old right at the left’s rightmost.</p><p><strong>Complexity:</strong> O(n) time, O(h) space</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-Ve-HF" id="tab-2g3xoRa" checked><label data-title="js" for="tab-2g3xoRa">js</label><input type="radio" name="group-Ve-HF" id="tab-aX7mfdX"><label data-title="py" for="tab-aX7mfdX">py</label><input type="radio" name="group-Ve-HF" id="tab-5GG5vVp"><label data-title="go" for="tab-5GG5vVp">go</label></div><div class="blocks"><div class="language-js vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">/**</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">	}</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div></div></div>`,4)]))}const o=i(l,[["render",p]]);export{g as __pageData,o as default};
