import{_ as s,c as i,o as a,a5 as n}from"./chunks/framework.DdR-ZOnh.js";const c=JSON.parse('{"title":"705. Design HashSet","description":"","frontmatter":{},"headers":[],"relativePath":"notes/leetcode/705.md","filePath":"notes/leetcode/705.md","lastUpdated":1685724191000}'),l={name:"notes/leetcode/705.md"},p=n(`<h1 id="_705-design-hashset" tabindex="-1">705. Design HashSet <a class="header-anchor" href="#_705-design-hashset" aria-label="Permalink to &quot;705. Design HashSet&quot;">​</a></h1><p><a href="https://leetcode.com/problems/design-hashset/" target="_blank" rel="noreferrer">https://leetcode.com/problems/design-hashset/</a></p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-wRoQZ" id="tab-rsCwRkN" checked><label data-title="JavaScript" for="tab-rsCwRkN">JavaScript</label><input type="radio" name="group-wRoQZ" id="tab-o3YmFG7"><label data-title="Python" for="tab-o3YmFG7">Python</label></div><div class="blocks"><div class="language-js vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">/**</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># obj.add(key)</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># obj.remove(key)</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># param_3 = obj.contains(key)</span></span></code></pre></div></div></div>`,3),t=[p];function h(k,e,r,d,y,E){return a(),i("div",null,t)}const F=s(l,[["render",h]]);export{c as __pageData,F as default};
